                ...
                <form method="post" action="{{ route('admin.support.reply', $ticket) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-7"><label class="form-label">Attachments</label><input class="form-control" type="file" name="attachments[]" multiple></div>
                        </div>
                    ...
                    <div class="card-footer text-end"><button class="btn btn-primary">Save message</button></div>
                </form>
            </div>
        </div>
        ...
        <div class="col-xl-4">
            <div class="card mb-3">
                ...
                <form method="post" action="{{ route('admin.support.update', $ticket) }}">@csrf @method('put')
                    ...
                    <div class="card-footer d-flex justify-content-between"><button class="btn btn-outline-primary" form="assign-to-me">Assign to me</button><button class="btn btn-primary">Update</button></div>
                </form>
                <form id="assign-to-me" method="post" action="{{ route('admin.support.assign', $ticket) }}">@csrf</form>
            </div>
