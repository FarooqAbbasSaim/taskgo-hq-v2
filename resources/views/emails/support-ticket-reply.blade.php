...
<div style="max-width:600px;background:#f7f7f7;padding:30px;border-radius:8px">
    ...
    <div style="padding:20px;background:#fff;line-height:1.6">
        ...
        <p>There is an update on ticket <strong>{{ $ticket->reference }}</strong> — {{ $ticket->subject }}.</p>
        <div style="margin:16px 0;padding:16px;background:#eef6ff;border:1px solid #bfd7f2;border-radius:6px;white-space:pre-wrap">{{ $ticketMessage->body }}</div>
