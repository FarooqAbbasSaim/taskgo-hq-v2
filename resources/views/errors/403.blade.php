@extends('layouts.base', ['title' => 'Access Forbidden'])
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="mb-4">
                            <div class="avatar avatar-xl mx-auto mb-3">
                                <span class="avatar-title bg-warning-subtle text-warning rounded-circle fs-2xl">
                                    <i data-lucide="shield-x" class="fs-xxl"></i>
                                </span>
                            </div>
                        </div>
