...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'A consistent and open-source icon set built for modern interfaces — explore and integrate Lucide Icons easily.',
        'badgeIcon' => 'trees',
        'badgeTitle' => 'Modern Icons',
    ])
        ...
        <div class="col-xxl-12">
            <div class="card">
                <div class="card-header d-block">
                    ...
                    <p class="mb-0 text-muted">Lucide is an open-source library of clean, scalable SVG icons for
                        web and app development, offering easy integration and customization.</p>
                </div>
                ...
                <div class="card-body border-top-0 rounded-top-0">
                    ...
                    <div class="text-center mt-3">
                        <a class="btn btn-danger" href="https://lucide.dev/icons/" target="_blank">View All
                            Icons</a>
                    </div>
                </div> <!-- end card-body-->
            </div> <!-- end card-->
