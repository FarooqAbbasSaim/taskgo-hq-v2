...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'Visualize chronological events, project milestones, or user actions in a streamlined, scrollable view.',
        'badgeIcon' => 'history',
        'badgeTitle' => 'Chronological View',
    ])
    ...
    <div class="row">
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Team members shared updates, discussed blockers, and aligned on
                                    weekly goals.</p>
                                <span class="text-primary fw-medium">By Olivia Rodriguez</span>
                            </div>
                        </div>
                        <!-- Event 2 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Introduced project scope, goals, and assigned initial roles to
                                    team members.</p>
                                <span class="text-primary fw-medium">By Isabella Cooper</span>
                            </div>
                        </div>
                        <!-- Event 3 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Reviewed initial UI mockups and gathered feedback for the next
                                    design iteration.</p>
                                <span class="text-primary fw-medium">By Ethan Murphy</span>
                            </div>
                        </div>
                        <!-- Event 4 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Discussed client feedback and agreed on key changes for the next
                                    sprint.</p>
                                <span class="text-primary fw-medium">By Liam Chen</span>
                            </div>
                        </div>
                        <!-- Event 5 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3">
                                ...
                                <p class="mb-1 text-muted">Successfully deployed the latest build to the staging
                                    environment.</p>
                                <span class="text-primary fw-medium">By Ava Thompson</span>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Timeline with Icons</h5>
                </div> <!-- end card-header-->
                <div class="card-body">
                    <div class="timeline timeline-icon-based">
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By Marcus Bell</span>
                            </div>
                        </div>
                        <!-- Event 2 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            <div class="timeline-time pe-3 text-muted">Today, 9:00 AM</div>
                            <div class="timeline-dot bg-primary-subtle">
                                <i class="ti ti-phone-call fs-xl text-primary"></i>
                            </div>
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Outlined Q2 goals and content plan for the product launch
                                    campaign.</p>
                                <span class="text-primary fw-medium">By Emily Davis</span>
                            </div>
                        </div>
                        <!-- Event 3 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Prioritized new features for the upcoming release based on user
                                    feedback.</p>
                                <span class="text-primary fw-medium">By Daniel Kim</span>
                            </div>
                        </div>
                        <!-- Event 4 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-dot bg-primary-subtle">
                                <i class="ti ti-layout-dashboard fs-xl text-primary"></i>
                            </div>
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By Sofia Martinez</span>
                            </div>
                        </div>
                        <!-- Event 5 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3">
                                ...
                                <p class="mb-1 text-muted">Reviewed backend API endpoints and applied new encryption
                                    standards.</p>
                                <span class="text-primary fw-medium">By Jonathan Lee</span>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
    ...
    <div class="row">
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Timeline with Border</h5>
                </div> <!-- end card-header-->
                <div class="card-body">
                    <div class="timeline timeline-icon-bordered">
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By Natalie Brooks</span>
                            </div>
                        </div>
                        <!-- Event 2 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By Oliver Grant</span>
                            </div>
                        </div>
                        <!-- Event 3 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Refined component spacing and color scheme for better
                                    accessibility.</p>
                                <span class="text-primary fw-medium">By Clara Jensen</span>
                            </div>
                        </div>
                        <!-- Event 4 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By Leo Armstrong</span>
                            </div>
                        </div>
                        <!-- Event 5 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3">
                                ...
                                <span class="text-primary fw-medium">By Mia Thompson</span>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
        ...
        <div class="col-xxl-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Timeline with Users</h5>
                </div> <!-- end card-header-->
                <div class="card-body">
                        ...
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">The new layout and theme for the analytics dashboard have been
                                    deployed.</p>
                                <span class="text-primary fw-medium">By Emma Carter</span>
                            </div>
                        </div>
                        <!-- Event 2 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <p class="mb-1 text-muted">Uploaded the latest documentation to help new users get started
                                    quickly.</p>
                                <span class="text-primary fw-medium">By Noah Mitchell</span>
                            </div>
                        </div>
                        <!-- Event 3 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By Ava Morgan</span>
                            </div>
                        </div>
                        <!-- Event 4 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3 pb-4">
                                ...
                                <span class="text-primary fw-medium">By James Parker</span>
                            </div>
                        </div>
                        <!-- Event 5 -->
                        <div class="timeline-item d-flex align-items-stretch">
                            ...
                            <div class="timeline-content ps-3">
                                ...
                                <p class="mb-1 text-muted">Hosted a live training session with 30+ clients on the new
                                    reporting tools.</p>
                                <span class="text-primary fw-medium">By Sophia Bennett</span>
                            </div>
                        </div>
                    </div>
                </div> <!-- end card-body-->
