...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'Enhance your tables with sorting, searching, and pagination using the powerful jQuery DataTables plugin.',
        'badgeIcon' => 'columns-3-cog',
        'badgeTitle' => 'Dynamic Tables',
    ])
    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header justify-content-between">
                    <h5 class="card-title"> Complex Header </h5>
                    <a class="icon-link icon-link-hover link-primary fw-semibold"
