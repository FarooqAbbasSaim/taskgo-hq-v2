...
@section('content')
    @include('layouts.shared.page-title', [
        ...
        'subTitle' =>
            'Enable row selection using checkboxes for bulk actions, form submissions, or item management within DataTables.',
        'badgeIcon' => 'square-check',
        'badgeTitle' => 'Multi-Select',
    ])
